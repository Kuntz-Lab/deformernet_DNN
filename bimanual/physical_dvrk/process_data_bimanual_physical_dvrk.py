...
data_processed_path = f"/home/baothach/shape_servo_data/rotation_extension/bimanual_physical_dvrk/multi_{args.obj_category}/processed_data"
...
with torch.no_grad():
    for i in range(start_index, max_len_data):
        ...
        # print('data["mani_point"].shape:', data["mani_point"].shape)
        # print("mp_pos_1.shape:", mp_pos_1.shape, "mp_pos_2.shape:", mp_pos_2.shape)
        ...
        if vis:
            ...
            open3d.visualization.draw_geometries([pcd, mani_point_1_sphere, mani_point_2_sphere, coor, pcd_goal])           
