...
data_processed_path = f"/home/baothach/shape_servo_data/rotation_extension/single_physical_dvrk/multi_{args.obj_category}/processed_data_object_frame_CAO"
...
with torch.no_grad():
    for i in range(start_index, max_len_data):
        ...
        if vis:
            ...
            coor_world = open3d.geometry.TriangleMesh.create_coordinate_frame(size=0.01)
